...
async function getSongs(folder){
    ...
    let api = await fetch(`https://github.com/YourwithD/spotify/tree/main/${folder}/`);
...
async function getArtist(folder){
    currentFolder = folder;
    songs = [];
    let api = await fetch(`https://github.com/YourwithD/spotify/tree/main/songs/PopularArtist/`);
    let responce = await api.text();
    let newDiv =  document.createElement("div");
    newDiv.innerHTML = responce;
    let as = newDiv.getElementsByTagName("a");
...
async function getAlbum(folder){
    currentFolder = folder;
    songs = [];
    let api = await fetch(`https://github.com/YourwithD/spotify/tree/main/songs/PopularAlbum/`);
    let responce = await api.text();
    let newDiv =  document.createElement("div");
    newDiv.innerHTML = responce;
    let as = newDiv.getElementsByTagName("a");
...
async function getSinger(folder){
    currentFolder = folder;
    songs = [];
    let api = await fetch(`https://github.com/YourwithD/spotify/tree/main/songs/PopularRadio/`);
    let responce = await api.text();
    let newDiv =  document.createElement("div");
    newDiv.innerHTML = responce;
    let as = newDiv.getElementsByTagName("a");
